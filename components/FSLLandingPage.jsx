    ...
    <div style={{ background: dark, color: white, fontFamily: "Georgia,'Times New Roman',serif", overflowX: "hidden", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "5rem 1.5rem", maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <p style={{ color: body, fontSize: "1rem", lineHeight: 1.75, maxWidth: "620px", marginBottom: "3rem" }}>
          FSL is decentralized infrastructure for sovereign data governance. Behavioral health is our first deployed instance &mdash; chosen because it imposes the strictest regulatory load, highest stigma cost, and most complex consent topology of any deployable domain. <strong style={{ color: cyan }}>EncryptHealth</strong> is the wellness education platform built on this infrastructure &mdash; a sovereign wellness school where the system teaches and licensed practitioners provide any real care. Your sovereign wellness record is anchored to your wallet, stored encrypted on IPFS &mdash; FSL never holds your data. FSL operates outside HIPAA scope by design: your data lives with you, not with us.
        </p>
