    ...
    <main className="min-h-screen bg-[#0A0A0A] text-white" style={{ fontFamily: "'Chakra Petch', sans-serif" }}>
              ...
              <a key={p.name} href={p.url} target="_blank" rel="noopener noreferrer" className="rounded-xl border p-5 transition-all hover:-translate-y-1" style={{ borderColor: `${p.color}20`, background: `${p.color}05` }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-[0.6rem] text-gray-300">{p.label}</p>
                  </div>
                </div>
      ...
      <section className="py-16 px-4 border-t border-gray-800/30">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="rounded-xl border border-[#00D9FF]/15 bg-[#00D9FF]/5 p-6 text-center">
            ...
            <p className="text-xs text-gray-300 leading-relaxed mb-4">Your record belongs to you. Invite a sovereign wellness practitioner to view only what you choose to share. Revoke access instantly — on-chain.</p>
          ...
          <div className="rounded-xl border border-[#FFD700]/15 bg-[#FFD700]/5 p-6 text-center">
            ...
            <p className="text-xs text-gray-300 leading-relaxed mb-4">Licensed A&H guidance for sovereign wellness coverage. HSA/FSA optimization. Out-of-network reimbursement. Auto-generated CMS-1500 superbills.</p>
      ...
      <section className="py-16 px-4 border-t border-gray-800/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-8 text-xs text-gray-300 max-w-lg mx-auto">No clinic owns your data. No insurance company decides your care. Just you, your wellness record, and the practitioners you trust.</p>
        </div>
      </section>
      ...
      <section className="py-14 px-4 border-t border-gray-800/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xs text-gray-300 mb-5">Pay with ISO 20022-aligned digital assets, fiat, or HSA/FSA. Your choice. Your sovereignty.</p>
      ...
      <section className="py-16 px-4 border-t border-gray-800/30">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-300 mb-8 max-w-xl mx-auto leading-relaxed">3% of every session — automatic, on-chain, transparent. Distributed annually to the practitioners whose participants achieve the highest frequency growth.</p>
          <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto mb-6">
            {[
              ...
              <div key={r.place} className="rounded-xl border p-3 text-center" style={{ borderColor: `${r.color}30`, background: `${r.color}08` }}>
                ...
                <p className="text-xs text-gray-300 mt-1">{r.place}</p>
      ...
      <section className="py-20 px-4 border-t border-gray-800/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-sm mb-8">No credit card. No diagnosis. No gatekeepers. Just wellness on your terms.</p>
          ...
          <p className="text-gray-300 text-xs mt-6">After trial: Wellness $19/mo · Sovereign $49/mo</p>
        </div>
      </section>
      ...
      <footer className="border-t border-gray-800/50 px-4 py-12">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xs text-gray-300 mb-1">Built by Future Systems Lab LLC — Wyoming Entity</p>
