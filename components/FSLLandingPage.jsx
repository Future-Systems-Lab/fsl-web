  ...
  return (
    <div style={{ background: dark, color: white, fontFamily: "Georgia,'Times New Roman',serif", overflowX: "hidden", minHeight: "100vh" }}>
      ...
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem 1.5rem", borderBottom: "1px solid rgba(0,217,255,0.08)", position: "sticky", top: 0, zIndex: 100, background: "rgba(3,11,15,0.95)", backdropFilter: "blur(12px)" }}>
        ...
        <button onClick={() => window.open("https://sovereignledger.pw", "_blank")} style={{ background: cyan, color: dark, border: "none", padding: "0.55rem 1.2rem", borderRadius: "2px", fontFamily: "Georgia,serif", fontSize: "0.78rem", letterSpacing: "0.06em", cursor: "pointer", fontWeight: "bold" }}>Claim Your Sovereign Record</button>
      </nav>
      ...
      <section style={{ background: dark, borderTop: "1px solid rgba(0,217,255,0.12)", padding: "6rem 1.5rem", textAlign: "center" }}>
        ...
        <button onClick={() => window.open("https://sovereignledger.pw", "_blank")} style={{ background: cyan, color: dark, border: "none", padding: "1.1rem 3rem", fontSize: "0.88rem", letterSpacing: "0.15em", textTransform: "uppercase", cursor: "pointer", borderRadius: "2px", fontFamily: "Georgia,serif", fontWeight: "bold" }}>
